module.exports = {
 ...
 ORDER BY listingValue DESC;`,
    ...
    scriptGetEmployerPendingJobs: "SELECT f.jobOfferId,f.jobOfferDescription,f.jobOfferDateAtCreate,f.jobOfferDateAtWork,f.jobOfferEstimatePrice,f.jobOfferTittle, j.jobId FROM joboffers f left join jobs j on j.jobOfferId=f.jobOfferId WHERE (j.jobStatus = 0 or j.jobStatus = 1) and f.userId=?;",
    ...
    scriptGetEmployerDoneJobs: "SELECT f.jobOfferId,f.jobOfferDescription,f.jobOfferDateAtCreate,f.jobOfferDateAtWork,f.jobOfferEstimatePrice,f.jobOfferTittle, j.jobId FROM joboffers f left join jobs j on j.jobOfferId=f.jobOfferId WHERE j.jobStatus = 4 and f.userId=?;",
